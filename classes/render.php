<?php
    ...
    class Render
    {
        ...
        public static function displayImages($results_array){
            ...
            public static function test($results_array){
$index = 0;
                $output = '';
        ...
        public static function displayModalImages($results_array){
            ...
            try{
                ...
                do{
                    ...
                    $output .= '<div class="col-md-3 col-md-12 playing">';
                    $output .= '<img class= "image img-responsive fade-in centered-images" data-toggle="modal" data-target="#myModal"<a href="http://instagram.com/p/'. $latest_array['code'].'" src='.$latest_array['display_src'].'>';
                    $output .= '</div>';
                ...
                $output .= '<div class="modal-content">';
                $output .= '<div class="modal-body">';
                $output .= '<a href="http://instagram.com/___skator___" target=_blank><img class="modal-img-responsive">';
                $output .= '</div>';
                $output .= '<div class="modal-footer">';
                $output .= '<div class="modal-icon">
   	                            <a href="">
